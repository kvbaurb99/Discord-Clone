...
export default function ChanellsBar({setShowServerForm, data, channelData}) {
  ...
  return (
    <div className='min-w-[80px] h-[screen] bg-[#1e2124] flex flex-col items-center'>
      ...
      <div onClick={() => navigate('/main')} className='w-full h-[45px] bg-[#424549] flex justify-center items-center cursor-pointer hover:bg-blue-500 hover:rounded-2xl rounded-full'>
        ...
        <div onClick={() => setShowServerForm(true)} className='w-[65%] h-[50px] bg-[#424549] mt-4 rounded-full flex justify-center items-center cursor-pointer text-green-600 hover:rounded-2xl hover:text-white hover:bg-green-600'>
