...
export default function Main({username, setData, setShowServerForm, serverData, showServerForm, channelData, userId, usersData, userFriends, logout, authData}) {
  ...
  return (
    <div className='w-[1000px] md:w-full h-screen flex overflow-x-hidden'>
        ...
        <MainBar username={username} userId={userId} usersData={usersData} />
