...
export default function Channel({title, color}) {
  ...
  return (
    <div onClick={() => navigate(`/channels/${title}`)} className={`w-[65%] h-[50px] ${color} mt-4 flex justify-center items-center cursor-pointer hover:bg-blue-500 border-gray-300 rounded-full hover:rounded-2xl relative`}>
